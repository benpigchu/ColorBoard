...
import colorListView from './components/colorListView.vue'
export default {
  name: 'app',
  props:["colorList"],
  components:{colorInfo,colorListView}
}
</script>

<style>
#app{position:fixed;width:100%;height:100%;margin:0;padding:0;left:0;top:0}
</style>